...
/**
 * Reusable Input component with semantic label, helper text, and error states.
 */
  ...
  return (
    <div className={`flex flex-col gap-1.5 w-full min-w-0 ${containerClassName}`}>
      ...
      <input
        ...
        className={`w-full px-3 py-2 text-sm text-content-primary bg-white border rounded-lg transition-colors placeholder:text-content-muted focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:bg-surface-muted disabled:text-content-muted disabled:cursor-not-allowed ${
          error
